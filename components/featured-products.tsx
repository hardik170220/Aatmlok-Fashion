  ...
  if (isLoading) {
    return (
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 mt-8">
        {[...Array(4)].map((_, index) => (
          <div key={index} className="rounded-lg border border-gray-200 bg-white shadow-sm p-4 h-[300px]">
            <div className="h-[200px] w-full bg-gray-200 animate-pulse rounded-md mb-4"></div>
